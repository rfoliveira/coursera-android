...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		// TODO - ok - Create a new intent to launch the SoundRecordActivity activity
		Intent it = new Intent(this, SoundRecordActivity.class);
				
		// TODO - ok - Use getOutputMediaFile() to create a new 
		// filename for this specific sound file
		String filename = getOutputMediaFile(MEDIA_TYPE_AUDIO).toString();
	...
	private void launchCameraIntent() {
		...
		// TODO - ok - Create a new intent to launch the MediaStore, Image capture function
	...
	private void launchVideoCameraIntent() {
		...
		startActivityForResult(it, CAMERA_VIDEO_REQUEST);
	}
